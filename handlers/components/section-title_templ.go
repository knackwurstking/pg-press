...
const (
	SectionTitleLevelMain SectionTitleLevel = 4
	SectionTitleLevelSub  SectionTitleLevel = 5
)

type SectionTitleLevel int8

func SectionTitle(level SectionTitleLevel, text string) templ.Component {
