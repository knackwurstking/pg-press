...
func RegisterAll(r *services.Registry, e *echo.Echo) {
	...
	nav.NewHandler(r, wsFeedHandler).RegisterRoutes(e)
	home.NewHandler(r).RegisterRoutes(e)
	auth.NewHandler(r).RegisterRoutes(e)
	feed.NewHandler(r).RegisterRoutes(e)
	help.NewHandler(r).RegisterRoutes(e)
	editor.NewHandler(r).RegisterRoutes(e)
	profile.NewHandler(r).RegisterRoutes(e)
	notes.NewHandler(r).RegisterRoutes(e)
	metalsheets.NewHandler(r).RegisterRoutes(e)
	umbau.NewHandler(r).RegisterRoutes(e)
	troublereports.NewHandler(r).RegisterRoutes(e)
