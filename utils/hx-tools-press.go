...
func HXGetPressMetalSheetsSectionContent(pressNumber models.PressNumber) templ.SafeURL {
	return BuildURL(
		fmt.Sprintf("/htmx/tools/press/%d/metal-sheets", pressNumber),
		nil,
	)
}
...
func HXGetPressCyclesSectionContent(pressNumber models.PressNumber) templ.SafeURL {
	return BuildURL(
		fmt.Sprintf("/htmx/tools/press/%d/cycles", pressNumber),
		nil,
	)
}
...
func HXGetPressCycleSummaryPDF(pressNumber models.PressNumber) templ.SafeURL {
	return BuildURL(
		fmt.Sprintf("/htmx/tools/press/%d/cycle-summary-pdf", pressNumber),
		nil,
	)
}

func HxPostPressRegenerations(press models.PressNumber) templ.SafeURL {
	return BuildURL(
		fmt.Sprintf("/htmx/tools/press/%d/regenerations", press),
		nil,
	)
}
