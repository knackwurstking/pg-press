...
- [ ] UI: Add press regeneration section to the press page, just like the tool page has one
- [ ] Fix the partial cycles calculation for tools, after adding a press regeneration, it is all messed up
