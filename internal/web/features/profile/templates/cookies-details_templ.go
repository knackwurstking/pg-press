...
func CookiesDetails(cookies []*models.Cookie) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(cookies) > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/profile/templates/cookies-details.templ`, Line: 14, Col: 35}
			}
			...
			for _, cookie := range cookies {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/profile/templates/cookies-details.templ`, Line: 28, Col: 51}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/profile/templates/cookies-details.templ`, Line: 29, Col: 59}
				}
				...
				templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(env.ServerPathPrefix + "/htmx/profile/cookies?value=" + cookie.Value)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/profile/templates/cookies-details.templ`, Line: 32, Col: 90}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" hx-trigger=\"click\" hx-target=\"#cookies\" hx-swap=\"outerHTML\" hx-confirm=\"Sind Sie sicher, dass Sie dieses Cookie löschen möchten?\" hx-on:htmx:response-error=\"alert(event.detail.xhr.responseText)\" role=\"button\" class=\"ghost destructive icon\" title=\"Sitzung beenden\"><i class=\"bi bi-trash\"></i></a></td></tr>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
