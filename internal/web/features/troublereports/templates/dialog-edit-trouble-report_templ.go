...
func DialogEditTroubleReport(props *DialogEditTroubleReportProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 185, Col: 23}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 200, Col: 19}
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "> <span>Markdown-Formatierung verwenden</span> <small class=\"muted\">(unterstützt **fett**, *kursiv*, # Überschriften, > Zitate, automatische Zeilenumbrüche, etc.)</small></label><!-- Markdown Tools --> <div id=\"markdown-tools\" style=\"display: none;\"><div id=\"markdown-preview\" class=\"markdown-preview\"><div id=\"preview-content\"></div></div></div><!-- Attachments Section --> <div id=\"attachments-section\" class=\"attachments-container flex flex-col gap\"><small class=\"attachments-label\">Bilder (max. 10MB pro Datei, max. 10 Dateien)</small> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if props.AttachmentError != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 233, Col: 57}
				}
			...
			if len(props.Attachments) > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 247, Col: 49}
				}
				...
				for attachmentIndex, attachment := range props.Attachments {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 253, Col: 50}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 256, Col: 58}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/features/troublereports/templates/dialog-edit-trouble-report.templ`, Line: 257, Col: 73}
					}
