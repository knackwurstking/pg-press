...
func metalSheetDialogContentPositionTop(props *EditMetalSheetProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 65, Col: 60}
			}
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 78, Col: 55}
			}
...
func metalSheetDialogContentPositionBottom(props *EditMetalSheetProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 94, Col: 60}
			}
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 107, Col: 55}
			}
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 119, Col: 59}
			}
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 132, Col: 53}
			}
		...
		if props.MetalSheet != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/shared/dialogs/edit-metalsheet.templ`, Line: 145, Col: 56}
			}
