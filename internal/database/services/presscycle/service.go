...
func (s *Service) GetPartialCycles(cycle *models.PressCycle) int64 {
...
func (s *Service) GetPressCyclesForTool(toolID int64) ([]*models.PressCycle, error) {
...
func (s *Service) GetPressCycles(pressNumber models.PressNumber, limit, offset int) ([]*models.PressCycle, error) {
