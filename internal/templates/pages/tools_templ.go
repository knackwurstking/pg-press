...
func ToolsPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<main class=\"container fluid\"><!-- TODO: List tools (upper and lower tools),\n\t\t\t\t\t   format + ID, link to sub page showing all information\n\t\t\t\t\t   about the tool (/tools/:id) --><!-- NOTE: Just some things i have in mind\n\n\t\t\t\taction buttons\n\t\t\t\t\tadd a new tool\n\t\t\t\t\tadd/edit a new metal sheet entry\n\t\t\t\t\t \tedit dialog, or a sub page\n\t\t\t\t\t\twhile typing, do background checks for existing data and display below\n\n\t\t\t \tlist tools\n\t\t\t\t\tif a tool was clicked\n\t\t\t\t     \taction buttons\n\t\t\t\t\t\t    share to pdf button, only enabled if a tool is selected\n\n\t\t\t\t\t\tselection\n\t\t\t\t\t\t\t<select: Upper Tool ID> <select: Lower Tool ID>\n\t\t\t\t\t\t\t100x100 G01 \t \t\t100x100 G02\n\n\t\t\t\t\t\toutput\n\t\t\t\t\t\t\tShowing notes for upper and lower tools\n\n\t\t\t\t\t\t\tMetal sheets table\n\t\t\t\t\t\t\t\tThickness in mm, with a belonging mass humidity (Optimal: 6%)\n\t\t\t\t\t\t\t\tMarke height in mm\n\t\t\t\t\t\t\t\tStempelfall (\"current\", \"max\"), (types: \"SACMI\", \"SITI\")\n\n\t\t\t\t\t\t\tCalculator based on existing table data (Experimental)\n\n\t\t\t--><!--div class=\"actions\"></div--><div class=\"tools\" style=\"display: flex; flex-direction: column; gap: 1.5rem;\"><div class=\"active-tools p\"><h3 class=\"mb\"><i class=\"bi bi-gear-fill mr\"></i> Eingebaute Werkzeuge</h3><ul class=\"flex flex-col gap m-0 p-0\" style=\"list-style: none;\"><li><a role=\"button\" href=\"#\" class=\"ghost contrast flex justify-between items-center\"><span class=\"flex gap-lg items-center\"><!-- Upper Tool --><small style=\"border-radius: var(--ui-radius);\" class=\"primary py-sm px\">Oben</small> <span>100x100 G01</span><!-- Separator --><span class=\"muted ghost\">|</span><!-- Lower Tool --><small style=\"border-radius: var(--ui-radius);\" class=\"primary py-sm px\">Unten</small> <span>100x100 G01</span></span> <i class=\"bi bi-chevron-right\"></i></a></li></ul></div><div class=\"all-tools p\"><h3 class=\"mb\"><i class=\"bi bi-archive mr\"></i> Alle Werkzeuge</h3><ul class=\"flex flex-col gap m-0 p-0\" style=\"list-style: none;\"><li><a role=\"button\" href=\"#\" class=\"ghost contrast flex justify-between items-center py px-lg\"><span>150x75 XXL01</span> <i class=\"bi bi-chevron-right\"></i></a></li><li><a role=\"button\" href=\"#\" class=\"ghost contrast flex justify-between items-center py px-lg\"><span>100x100 G01</span> <i class=\"bi bi-chevron-right\"></i></a></li><li><a role=\"button\" href=\"#\" class=\"ghost contrast flex justify-between items-center py px-lg\"><span>100x100 G02</span> <i class=\"bi bi-chevron-right\"></i></a></li></ul></div></div></main>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
